...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
        ...
        // Lấy các đơn của 1 khách hàng đang giao nhau với khoảng thời gian [startTime,
        // endTime]
        ...
        @Query(value = "SELECT COUNT(*) FROM reservation " +
                        "WHERE type = 'ONLINE' " +
                        "AND start_time BETWEEN :from AND :to", nativeQuery = true)
        ...
        List<Object[]> findNextBookingForTables(@Param("tableIds") List<Long> tableIds,
